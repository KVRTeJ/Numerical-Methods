function [result, gramMatrix] = calculateByOrthogonalPolynomial(abscissaAxis, ordinateAxis, x, degree)
    ...
    for i = 3:1:degree
        resOrthogonalPolynomial(1, i) = (newX * resOrthogonalPolynomial(1, i - 1)) - (1/4 * resOrthogonalPolynomial(1, i - 2));
    end
    ...
    for i = 3:1:degree
        for j = 1:1:lengthOrdinateAxis
                orthogonalPolynomial(j, i) = (newAbscissaAxis(j) * orthogonalPolynomial(j, i - 1)) - (1/4 * orthogonalPolynomial(j, i - 2));
        end
